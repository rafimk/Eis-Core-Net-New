...
(
    ID VARCHAR (50) NOT NULL CONSTRAINT EIS_ROUTE_LOCK_PK PRIMARY KEY,
    HOST_IP_ADDRESS VARCHAR (255),
    LAST_ACCESSED_TIMESTAMP datetime DEFAULT GETDATE(),
    GROUP_KEY VARCHAR (50)
);


CREATE TABLE IF NOT EXISTS EIS_EVENT_INBOX_OUTBOX
(
    ID VARCHAR(50) NOT NULL CONSTRAINT EIS_COMPETING_CONSUMER_GROUP_PK PRIMARY KEY,
